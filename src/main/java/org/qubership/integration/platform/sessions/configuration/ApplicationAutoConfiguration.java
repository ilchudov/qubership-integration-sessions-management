...
@AutoConfiguration
@ComponentScan(value = {"org.qubership.integration.platform.sessions"})
@EnableConfigurationProperties(value = {InternalServicesProperties.class, SessionsProperties.class})
